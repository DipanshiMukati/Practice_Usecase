...
public final class ModelFactory {
	...
	public FavoriteListModelInt getFavoriteListModel() {

		FavoriteListModelInt FavoriteListModel = (FavoriteListModelInt) modelCache.get("FavoriteListModel");
		if (FavoriteListModel == null) {
			if ("Hibernate".equals(DATABASE)) {
				FavoriteListModel = new FavoriteListModelHibImp() {
				};
			}
			
			modelCache.put("FavoriteListModel",FavoriteListModel);
		}
	...
	public ItemInformationModelInt getItemInformationModel() {
		ItemInformationModelInt ItemInformationModel = (ItemInformationModelInt) modelCache.get("ItemInformation");
		if (ItemInformationModel == null) {
			if ("Hibernate".equals(DATABASE)) {
				ItemInformationModel = new ItemInformationModelHibImp();
			}
			
			modelCache.put("ItemInformation", ItemInformationModel);
		}
	...
	public PortfolioManagementModelInt getPortfolioManagementModel() {
		...
		if (PortfolioManagementModel == null) {
			if ("Hibernate".equals(DATABASE)) {
				PortfolioManagementModel = new PortfolioManagementModelHibImp();
			}

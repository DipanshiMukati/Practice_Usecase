...
<body class="hm">
	...
	<div>
		<form class="pb-5" action="<%=ORSView.ITEMINFORMATION_LIST_CTL%>"
			...
			%>
			<center>
				<h1 class="text-secondary font-weight-bold pt-3">ItemInformation
					List</h1>
			</center>
			<div class="row">
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="text" name="overview"
						...
						oninput="handleLetterInput(this, 'overviewError', 200)"
						onblur="validateLetterInput(this, 'overviewError', 200)"
						value="<%=ServletUtility.getParameter("overview", request)%>">

					<font color="red" class="pl-sm-5" id="overviewError"></font>
	...
	<div style="margin-bottom: 20px;" class="table-responsive">
		<table class="table table-bItemInformationed table-dark table-hover">
			<thead>
			...
			<%
				while (it.hasNext()) {
						dto = (ItemInformationDTO) it.next();
			%>
			<tbody>
				<tr>
					...
					<td class="text comment-column"><%=dto.getOverview()%></td>
				...
				<td class="text"><%=map.get(Integer.parseInt(dto.getCategory()))%></td>
					...
					<td class="text"><a href="ItemInformationCtl?id=<%=dto.getId()%>">Edit</a></td>
				</tr>
			</tbody>
			<%
				}
	...
	%>
	<center>
		<h1 style="font-size: 40px; color: #162390;">ItemInformation List</h1>
	</center>
	</br>
	<div class="row">
		<div class="col-md-4"></div>
		...
		<div style="padding-left: 48%;">
			<input type="submit" name="operation" class="btn btn-primary btn-md"
				style="font-size: 17px" value="<%=ItemInformationListCtl.OP_BACK%>">
		</div>

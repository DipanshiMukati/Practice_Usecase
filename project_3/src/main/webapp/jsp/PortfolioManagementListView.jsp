...
<body class="hm">
	...
	<div>
		<form class="pb-5" action="<%=ORSView.PORTFOLIOMANAGEMENT_LIST_CTL%>"
			...
			%>
			<center>
				<h1 class="text-secondary font-weight-bold pt-3">PortfolioManagement
					List</h1>
			</center>
			<div class="row">
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="text" name="strategy" placeholder="Enter strategy"
						class="form-control"
				...
				<div class="col-sm-2">
					<input type="text" name="amount" placeholder="Enter cost"
						class="form-control"
				...
				<div class="col-sm-2"><%=HTMLUtility.getList1("level", String.valueOf(dto.getLevel()), map)%></div>
	...
	<div style="margin-bottom: 20px;" class="table-responsive">
		<table
			class="table table-bPortfolioManagemented table-dark table-hover">
			<thead>
				<tr style="background-color: purple;">
					...
					<th width="15%" class="text">Level</th>
					<th width="15%" class="text">Strategy</th>
			...
			<%
				while (it.hasNext()) {
						dto = (PortfolioManagementDTO) it.next();
			%>
			<tbody>
				<tr>
					...
					<td class="text comment-column"><%=dto.getStrategy()%></td>

...
<%-- 
				<li class="nav-item dropdown" style="padding-left: 5px;"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.ITEMINFORMATION_CTL%>"> <i
							class="fas fa-user-circle"></i>Add ItemInformation
						</a> <a class="dropdown-item" href="<%=ORSView.ITEMINFORMATION_LIST_CTL%>"><i
							class="fas fa-user-friends"></i>ItemInformation List</a>
					</div></li>
				...
				<li class="nav-item dropdown" style="padding-left: 5px;"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: Black;">FavoriteList</font>
				</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.FAVORITELIST_CTL%>"> <i
							class="fas fa-user-circle"></i>Add FavoriteList
						</a> <a class="dropdown-item" href="<%=ORSView.FAVORITELIST_LIST_CTL%>"><i
							class="fas fa-user-friends"></i>FavoriteList List</a>
					</div></li>

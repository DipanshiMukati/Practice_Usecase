...
<body class="hm">
	...
	<div>
		<form class="pb-5" action="<%=ORSView.FAVORITELIST_LIST_CTL%>"
			...
			%>
			<center>
				<h1 class="text-secondary font-weight-bold pt-3">FavoriteList
					List</h1>
			</center>
			<div class="row">
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="comment" placeholder="Enter comment"
						class="form-control"
						oninput="handleLetterInput(this, 'commentError', 200)"
						onblur="validateLetterInput(this, 'commentError', 200)" >
                      <%=ServletUtility.getParameter("comment", request)%>

					<font color="red" class="pl-sm-5" id="commentError"></font>
				</div>
				...
				<input type="submit" class="btn btn-primary btn-md"
					...
					name="operation" value="<%=FavoriteListListCtl.OP_RESET%>">
			</div>
	...
	<div style="margin-bottom: 20px;" class="table-responsive">
		<table class="table table-bFavoriteListed table-dark table-hover">
			<thead>
				<tr style="background-color: purple;">
					...
					<th width="15%" class="text">Nots Or Comment</th>
			...
			<tbody>
				<tr>
					...
					<td class="text"><%=dto.getUserName()%></td>
                     <td class="text comment-column"><%=dto.getComment()%></td>
                                   
        </td>


					<td class="text"><a href="FavoriteListCtl?id=<%=dto.getId()%>">Edit</a></td>
				</tr>
			</tbody>
			<%
				}
	...
	<div class="row">
		...
		<div style="padding-left: 48%;">
			<input type="submit" name="operation" class="btn btn-primary btn-md"
				style="font-size: 17px" value="<%=FavoriteListListCtl.OP_BACK%>">
		</div>
